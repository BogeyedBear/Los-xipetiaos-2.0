...
public class Lavadora : MonoBehaviour
{
    ...
    private void Cerca()
    {
        ...
        float restaX = Mathf.Abs(lavadora.position.x - player.transform.position.x);
        float restaY = Mathf.Abs(lavadora.position.y - player.transform.position.y);
